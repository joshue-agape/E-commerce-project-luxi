                ...
                <div className="py-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
                    <div className="lg:col-span-2">
                        <div className="mb-4 flex items-center gap-2 text-xl font-semibold">
                            <div className="flex h-8 w-8 items-center justify-center bg-white text-zinc-900">
                                <span className="text-sm font-bold">L</span>
                            </div>
                            <span>LUXE STORE</span>
                        </div>
                        <p className="mb-6 max-w-sm text-sm leading-relaxed text-zinc-400">
                            Votre destination premium pour des produits d'exception. Qualité,
                            élégance et service client irréprochable depuis 2010.
                        </p>
                        <div className="space-y-3">
                            <div className="flex items-center gap-3 text-sm text-zinc-400">
                                <Mail className="h-4 w-4" />
                                <span>contact@luxestore.com</span>
                            </div>
                            <div className="flex items-center gap-3 text-sm text-zinc-400">
